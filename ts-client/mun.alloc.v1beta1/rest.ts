...
type.
*/
export type V1Beta1MsgFundFairburnPoolResponse = object;

export interface V1Beta1Params {
  distribution_proportions?: V1Beta1DistributionProportions;
  weighted_developer_rewards_receivers?: V1Beta1WeightedAddress[];
}
...
export interface V1Beta1WeightedAddress {
  address?: string;
  weight?: string;
}
...
/**
 * @title alloc/v1beta1/genesis.proto
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/mun/alloc/v1beta1/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<V1Beta1QueryParamsResponse, RpcStatus>({
      path: `/mun/alloc/v1beta1/params`,
      method: "GET",
      format: "json",
      ...params,
    });
