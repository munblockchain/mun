...
func TestFullAppSimulation(t *testing.T) {
	...
	app := NewMunApp(logger, db, nil, true, map[int64]bool{}, DefaultNodeHome, simapp.FlagPeriodValue, MakeEncodingConfig(),
		EmptyAppOptions{}, fauxMerkleModeOpt)
	require.Equal(t, "mun", app.Name())
...
func TestAppImportExport(t *testing.T) {
	...
	app := NewMunApp(logger, db, nil, true, map[int64]bool{}, DefaultNodeHome, simapp.FlagPeriodValue, MakeEncodingConfig(), EmptyAppOptions{}, fauxMerkleModeOpt)
	require.Equal(t, "mun", app.Name())
	...
	newApp := NewMunApp(log.NewNopLogger(), newDB, nil, true, map[int64]bool{}, DefaultNodeHome, simapp.FlagPeriodValue, MakeEncodingConfig(), EmptyAppOptions{}, fauxMerkleModeOpt)
	require.Equal(t, "mun", newApp.Name())
	...
	storeKeysPrefixes := []StoreKeysPrefixes{
		// {app.GetKey(authtypes.StoreKey), newApp.GetKey(authtypes.StoreKey), [][]byte{authtypes.GlobalAccountNumberKey}},
		...
		{app.GetKey(claimtypes.StoreKey), newApp.GetKey(claimtypes.StoreKey), [][]byte{}},
		{app.GetKey(ibanktypes.StoreKey), newApp.GetKey(ibanktypes.StoreKey), [][]byte{}},
	}
...
func TestAppStateDeterminism(t *testing.T) {
	...
	for i := 0; i < numSeeds; i++ {
		...
		for j := 0; j < numTimesToRunPerSeed; j++ {
			...
			db := dbm.NewMemDB()
			app := NewMunApp(logger, db, nil, true, map[int64]bool{}, DefaultNodeHome, simapp.FlagPeriodValue, MakeEncodingConfig(), EmptyAppOptions{}, interBlockCacheOpt())
