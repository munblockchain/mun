...
var (
	Upgrades = []munupgrade.UpgradeMun{v2.Upgrade, v2_0_3.Upgrade, v3.Upgrade}
)
...
func New(
	...
	keys := sdk.NewKVStoreKeys(
		...
		evidencetypes.StoreKey, ibctransfertypes.StoreKey, icahosttypes.StoreKey, capabilitytypes.StoreKey, monitoringptypes.StoreKey,
	...
	app.MunKeeper = *munmodulekeeper.NewKeeper(
		appCodec,
		keys[munmoduletypes.StoreKey],
		keys[munmoduletypes.MemStoreKey],
		app.GetSubspace(munmoduletypes.ModuleName),
