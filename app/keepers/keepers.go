...
// NewAppKeepers returns AppKeepers with initialized keepers
func NewAppKeepers(
	...
	moduleAccAddrs map[string]bool,
	...
	app.IbankKeeper = *ibankmodulekeeper.NewKeeper(
		appCodec,
		keys[ibankmoduletypes.StoreKey],
