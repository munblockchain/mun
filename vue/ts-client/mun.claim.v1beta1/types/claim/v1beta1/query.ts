...
import { Action, actionFromJSON, actionToJSON, ClaimRecord } from "./claim_record";
...
export const QueryModuleAccountBalanceRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryModuleAccountBalanceRequest>, I>>(
    _: I,
...
export const QueryModuleAccountBalanceResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryModuleAccountBalanceResponse>, I>>(
    object: I,
...
export class QueryClientImpl implements Query {
  ...
  ModuleAccountBalance(request: QueryModuleAccountBalanceRequest): Promise<QueryModuleAccountBalanceResponse> {
    ...
    const promise = this.rpc.request("mun.claim.v1beta1.Query", "ModuleAccountBalance", data);
  ...
  ClaimRecord(request: QueryClaimRecordRequest): Promise<QueryClaimRecordResponse> {
    ...
    const promise = this.rpc.request("mun.claim.v1beta1.Query", "ClaimRecord", data);
  ...
  ClaimableForAction(request: QueryClaimableForActionRequest): Promise<QueryClaimableForActionResponse> {
    ...
    const promise = this.rpc.request("mun.claim.v1beta1.Query", "ClaimableForAction", data);
  ...
  TotalClaimable(request: QueryTotalClaimableRequest): Promise<QueryTotalClaimableResponse> {
    ...
    const promise = this.rpc.request("mun.claim.v1beta1.Query", "TotalClaimable", data);
