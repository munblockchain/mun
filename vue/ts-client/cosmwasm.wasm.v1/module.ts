...
export { MsgUpdateAdmin, MsgInstantiateContract2, MsgIBCSend, MsgStoreCode, MsgClearAdmin, MsgExecuteContract, MsgIBCCloseChannel, MsgInstantiateContract, MsgMigrateContract };
