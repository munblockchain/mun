...
import MunIbank from './mun.ibank'
import MunMun from './mun.mun'
import TendermintSpnClaim from './tendermint.spn.claim'
...
export default { 
  ...
  MunIbank: load(MunIbank, 'mun.ibank'),
  MunMun: load(MunMun, 'mun.mun'),
  TendermintSpnClaim: load(TendermintSpnClaim, 'tendermint.spn.claim'),
