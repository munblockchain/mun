...
import { GenesisState_GenMsgs } from "mun-client-ts/cosmwasm.wasm.v1/types"
import { Code } from "mun-client-ts/cosmwasm.wasm.v1/types"
import { Contract } from "mun-client-ts/cosmwasm.wasm.v1/types"
import { Sequence } from "mun-client-ts/cosmwasm.wasm.v1/types"
import { StoreCodeProposal } from "mun-client-ts/cosmwasm.wasm.v1/types"
import { InstantiateContractProposal } from "mun-client-ts/cosmwasm.wasm.v1/types"
import { MigrateContractProposal } from "mun-client-ts/cosmwasm.wasm.v1/types"
import { SudoContractProposal } from "mun-client-ts/cosmwasm.wasm.v1/types"
import { ExecuteContractProposal } from "mun-client-ts/cosmwasm.wasm.v1/types"
import { UpdateAdminProposal } from "mun-client-ts/cosmwasm.wasm.v1/types"
import { ClearAdminProposal } from "mun-client-ts/cosmwasm.wasm.v1/types"
import { PinCodesProposal } from "mun-client-ts/cosmwasm.wasm.v1/types"
import { UnpinCodesProposal } from "mun-client-ts/cosmwasm.wasm.v1/types"
import { AccessConfigUpdate } from "mun-client-ts/cosmwasm.wasm.v1/types"
import { UpdateInstantiateConfigProposal } from "mun-client-ts/cosmwasm.wasm.v1/types"
import { CodeInfoResponse } from "mun-client-ts/cosmwasm.wasm.v1/types"
import { AccessTypeParam } from "mun-client-ts/cosmwasm.wasm.v1/types"
import { AccessConfig } from "mun-client-ts/cosmwasm.wasm.v1/types"
import { Params } from "mun-client-ts/cosmwasm.wasm.v1/types"
import { CodeInfo } from "mun-client-ts/cosmwasm.wasm.v1/types"
import { ContractInfo } from "mun-client-ts/cosmwasm.wasm.v1/types"
import { ContractCodeHistoryEntry } from "mun-client-ts/cosmwasm.wasm.v1/types"
import { AbsoluteTxPosition } from "mun-client-ts/cosmwasm.wasm.v1/types"
import { Model } from "mun-client-ts/cosmwasm.wasm.v1/types"
...
export default {
	...
	actions: {
		...
		async sendMsgInstantiateContract2({ rootGetters }, { value, fee = [], memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const result = await client.CosmwasmWasmV1.tx.sendMsgInstantiateContract2({ value, fee: {amount: fee, gas: "200000"}, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
