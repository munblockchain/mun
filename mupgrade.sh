...
cd $HOME/.mun/upgrade_manager/upgrades && mkdir mun-upgrade-v3 && cd mun-upgrade-v3 && mkdir bin
cp $HOME/go/bin/mund $HOME/.mun/upgrade_manager/upgrades/mun-upgrade-v3/bin/
